		...
		if ( $with_flags ) {
			foreach ( $languages_configured as $lang ) {
				if ( ! empty( $flags_positions[ $type_flags ][ $lang ] ) ) {
					$css .= '.weglot-flags.flag-' . $type_flags . '.' . $lang . ' > a:before, .weglot-flags.flag-' . $type_flags . '.' . $lang . ' > span:before { background-position: ' . $flags_positions[ $type_flags ][ $lang ] . 'px 0 !important; }';
				}
			}
		}
